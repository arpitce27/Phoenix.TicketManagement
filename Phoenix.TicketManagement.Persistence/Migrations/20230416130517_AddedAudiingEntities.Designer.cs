            ...
            modelBuilder.Entity("Phoenix.TicketManagement.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = new Guid("9983a002-ed2d-4754-821a-bba7414eaf56"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2023, 10, 16, 9, 5, 17, 419, DateTimeKind.Local).AddTicks(494),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("9983a002-ed2d-4754-821a-bba7414eaf56"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2023, 8, 16, 9, 5, 17, 419, DateTimeKind.Local).AddTicks(589),
                            Description = "Lorem Ipsum is simply dummy text of the printing and typesetting industry.",
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("9983a002-ed2d-4754-821a-bba7414eaf56"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2023, 8, 16, 9, 5, 17, 419, DateTimeKind.Local).AddTicks(603),
                            Description = "Lorem Ipsum is simply dummy text of the printing and typesetting industry.",
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("9983a002-ed2d-4754-821a-bba7414eaf56"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2023, 7, 16, 9, 5, 17, 419, DateTimeKind.Local).AddTicks(614),
                            Description = "Lorem Ipsum is simply dummy text of the printing and typesetting industry.",
            ...
            modelBuilder.Entity("Phoenix.TicketManagement.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DatePlaced = new DateTime(2023, 4, 16, 9, 5, 17, 419, DateTimeKind.Local).AddTicks(632),
                            OrderPaid = true,
                            OrderTotal = 400,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DatePlaced = new DateTime(2023, 4, 16, 9, 5, 17, 419, DateTimeKind.Local).AddTicks(648),
                            OrderPaid = true,
                            OrderTotal = 180,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DatePlaced = new DateTime(2023, 4, 16, 9, 5, 17, 419, DateTimeKind.Local).AddTicks(658),
                            OrderPaid = true,
                            OrderTotal = 135,
